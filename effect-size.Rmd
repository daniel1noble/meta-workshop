...
pacman::p_load(metafor, flextable, tidyverse, orchaRd, pander, mathjaxr, equatags, tidyverse)
# To use mathjaxr you need to run equatags::mathjax_install()
```
...
## Visualising Cohen's d

<iframe width="800px" height="800px" src="https://rpsychologist.com/cohend/?embed=1&CER=20&M0=100&M0lab=Control&M1=103.3&M1lab=Treatment&SD=15&c0=r-48_g-57_b-79_a-1&c1=r-0_g-0_b-0_a-1&c2=r-106_g-206_b-235_a-1&d=0.22&slider=1&xlab=Outcome" frameborder="0"></iframe>
