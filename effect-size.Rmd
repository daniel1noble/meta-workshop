...
We'll use `metafor` to demonstrate how to calculate three major effect size esatimtes commonly used in comparative physiology, including Z-transformed correlation coefficients (Zr), log response ratios and Hedges'*d/g*. We'll focus on 
